...
import { data } from "./data.js"; // Import data dari file data.js
...
function GeminiAi() {
  ...
  const handleSubmit = async (event) => {
    ...
    const spesificPrompt = `Anda adalah chatbot yang melayani pertanyaan seputar film berdasarkan data berikut: ${JSON.stringify(
      dataState
    )}. Jawab pertanyaan berikut sesuai data film: ${prompt}`;
    ...
    try {
      ...
      const result = await chat.sendMessageStream(spesificPrompt);
